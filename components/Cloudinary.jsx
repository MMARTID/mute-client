...
const Cloudinary = (props) => {
    ...
    const preset_name = "default-img";                         //16 Pegamos el "name" rescatado en el punto 24
    const cloud_name = "dzpcrgb3m"                          //16.2 Pegamos el cloud_name rescatado en punto 20
    ...
    const uploadImage = async (e)=>{            //2 Preparamos para recibir el evento al ejecutarse la función async
        ...
        try {
            ...
            setProfilePicture(file.secure_url);              //13 Recuperamos la url de la imagen en estado local
  ...
  return (
    <div>
        ...
        <img src={profilePicture} alt="imagen subida" style={{ width: '200px' }} />
        )}
        {/* ------------------------------------------------------------------------------------ */}
